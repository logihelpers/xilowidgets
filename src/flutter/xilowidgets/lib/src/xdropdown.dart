...
import 'package:flet/src/utils/form_field.dart';
import 'package:flet/src/controls/textfield.dart';

class XDropdownControl extends StatefulWidget {
  ...
  @override
  State<XDropdownControl> createState() => _XDropdownControlState();
}

class _XDropdownControlState extends State<XDropdownControl> with FletStoreMixin {
  String? _value;
